...
IC D3D11_PRIMITIVE_TOPOLOGY TranslateTopology(D3DPRIMITIVETYPE T)
{
	static	D3D11_PRIMITIVE_TOPOLOGY translateTable[] =
	{
		D3D11_PRIMITIVE_TOPOLOGY_UNDEFINED,		//	None
		D3D11_PRIMITIVE_TOPOLOGY_POINTLIST,		//	D3DPT_POINTLIST = 1,
		D3D11_PRIMITIVE_TOPOLOGY_LINELIST,		//	D3DPT_LINELIST = 2,
		D3D11_PRIMITIVE_TOPOLOGY_LINESTRIP,		//	D3DPT_LINESTRIP = 3,
		D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST,	//	D3DPT_TRIANGLELIST = 4,
		D3D11_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP,	//	D3DPT_TRIANGLESTRIP = 5,
		D3D11_PRIMITIVE_TOPOLOGY_UNDEFINED,		//	D3DPT_TRIANGLEFAN = 6,
	};

	VERIFY(T<sizeof(translateTable)/sizeof(translateTable[0]));
	VERIFY(T>=0);

	D3D11_PRIMITIVE_TOPOLOGY	result = translateTable[T];

	VERIFY( result != D3D11_PRIMITIVE_TOPOLOGY_UNDEFINED );
...
IC void CBackend::ApplyPrimitieTopology( D3D11_PRIMITIVE_TOPOLOGY Topology )
{
...
IC void CBackend::Render(D3DPRIMITIVETYPE T, u32 baseV, u32 startV, u32 countV, u32 startI, u32 PC)
{
	...
	D3D11_PRIMITIVE_TOPOLOGY Topology = TranslateTopology(T);
