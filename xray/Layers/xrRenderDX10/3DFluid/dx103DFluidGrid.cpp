...
void dx103DFluidGrid::CreateVertexBuffers()
{
	...
	//	D3D11_BIND_VERTEX_BUFFER, &renderQuadBuffer, renderQuad, numVerticesRenderQuad));
	...
	//	D3D11_BIND_VERTEX_BUFFER, &slicesBuffer, slices , numVerticesSlices));
	...
	//	D3D11_BIND_VERTEX_BUFFER, &boundarySlicesBuffer, boundarySlices, numVerticesBoundarySlices));
	...
	//	D3D11_BIND_VERTEX_BUFFER, &boundaryLinesBuffer, boundaryLines, numVerticesBoundaryLines));
...
void dx103DFluidGrid::DrawSlices( void )
{
	...
	//UINT offset[1] = { 0 };
	//DrawPrimitive( D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST, layout, &slicesBuffer,
...
void dx103DFluidGrid::DrawSlicesToScreen( void )
{
	//UINT stride[1] = { sizeof(VS_INPUT_FLUIDSIM_STRUCT) };
	//UINT offset[1] = { 0 };
	//DrawPrimitive( D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST, layout, &renderQuadBuffer,
...
void dx103DFluidGrid::DrawBoundaryQuads( void )
{
	//UINT stride[1] = { sizeof(VS_INPUT_FLUIDSIM_STRUCT) };
	//UINT offset[1] = { 0 };
	//DrawPrimitive( D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST, layout, &boundarySlicesBuffer,
...
//	UINT stride[1] = { sizeof(VS_INPUT_FLUIDSIM_STRUCT) };
//	UINT offset[1] = { 0 };
//	DrawPrimitive( D3D11_PRIMITIVE_TOPOLOGY_LINELIST, layout, &boundaryLinesBuffer, 
