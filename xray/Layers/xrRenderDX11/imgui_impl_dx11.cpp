...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        D3DCompile(vertexShader, strlen(vertexShader), NULL, NULL, NULL, "main", "vs_4_0_level_9_1", 0, 0, &g_pVertexShaderBlob, NULL);
    ...
    // Create the pixel shader
    {
        ...
        D3DCompile(pixelShader, strlen(pixelShader), NULL, NULL, NULL, "main", "ps_4_0_level_9_1", 0, 0, &g_pPixelShaderBlob, NULL);
